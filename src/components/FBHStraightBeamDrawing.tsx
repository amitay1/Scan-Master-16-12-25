  ...
  return (
    <div className="relative border rounded-lg bg-white flex flex-col items-center">
      ...
      >
        ...
        {/* Center crosshairs */}
        <line
          x1={topViewCenterX - circleRadius - 15}
          y1={topViewCenterY}
          x2={topViewCenterX + circleRadius + 15}
          y2={topViewCenterY}
          stroke="#333"
          strokeWidth={0.5}
          strokeDasharray="10,5"
        ...
        <line
          x1={topViewCenterX}
          y1={topViewCenterY - circleRadius - 15}
          x2={topViewCenterX}
          y2={topViewCenterY + circleRadius + 15}
          stroke="#333"
          strokeWidth={0.5}
          strokeDasharray="10,5"
        />
        ...
        {/* Center point */}
        <circle cx={topViewCenterX} cy={topViewCenterY} r={3} fill="#333" />
        ...
        {showDimensions && (
          <>
            ...
            <g>
              <line
                x1={topViewCenterX + 8}
                y1={topViewCenterY - circleRadius + 12}
                x2={topViewCenterX + 28}
                y2={topViewCenterY - circleRadius - 8}
                stroke="#333"
                strokeWidth={1}
              />
              <text x={topViewCenterX + 32} y={topViewCenterY - circleRadius - 8} fill="#333" style={{ fontSize: 12 }}>D</text>
            </g>

            {/* C - Diameter at bottom */}
            <g>
              <line
                x1={topViewCenterX - circleRadius}
                y1={topViewCenterY + circleRadius + 22}
                x2={topViewCenterX + circleRadius}
                y2={topViewCenterY + circleRadius + 22}
                stroke="#333"
                strokeWidth={1}
              />
              <line x1={topViewCenterX - circleRadius} y1={topViewCenterY + circleRadius + 16} x2={topViewCenterX - circleRadius} y2={topViewCenterY + circleRadius + 28} stroke="#333" strokeWidth={1} />
              <line x1={topViewCenterX + circleRadius} y1={topViewCenterY + circleRadius + 16} x2={topViewCenterX + circleRadius} y2={topViewCenterY + circleRadius + 28} stroke="#333" strokeWidth={1} />
              <text x={topViewCenterX} y={topViewCenterY + circleRadius + 42} textAnchor="middle" fill="#333" style={{ fontSize: 12 }}>C</text>
            </g>
          </>
        )}
