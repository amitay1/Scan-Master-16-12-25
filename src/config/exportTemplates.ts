...
export const exportTemplates: Record<ExportTemplate, TemplateConfiguration> = {
  ...
  tuv: {
    ...
    description: "TÜV-style comprehensive professional report with full documentation",
    estimatedPages: "19 pages",
    sections: {
      coverPage: true,
      tableOfContents: true,
      inspectionSetup: true,
    ...
    bestFor: "TÜV certification, international standards compliance, professional certification bodies",
  },
};
