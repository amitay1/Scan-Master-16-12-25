...
# Example License Generation Script for Scan Master
# Run this to generate sample licenses for testing
...
# Example 2: Full License (All Standards)
...
# Example 3: Trial License (1 year)
...
# Example 4: Premium License (AMS + MIL)
...
# Example 5: European License (BS3 + BS4)
